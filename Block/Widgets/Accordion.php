...
class Accordion extends HyvaWidget implements BlockInterface
{
    public function __construct(
        protected Conditions $conditionsHelper,
        Context $context,
        protected string $_mainTemplate = 'MageOS_Widgetkit::widget/hyva/accordion/template.phtml',
        array $data = []
    ) {
    ...
    public function renderMainTemplate(): string
    {
        return $this->getLayout()->createBlock(
            ...
            [
                'params' => $this->getData(),
                'items'  => $this->getRepeatableField('repeatable_accordion_items')
            ]
        )->toHtml();
    }
}
