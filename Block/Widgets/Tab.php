...
class Tab extends HyvaWidget implements BlockInterface
{
    public function __construct(
        protected Conditions $conditionsHelper,
        Context $context,
        protected string $_mainTemplate = 'MageOS_Widgetkit::widget/hyva/tab/template.phtml',
        array $data = []
    ) {
    ...
    public function renderMainTemplate(): string
    {
        return $this->getLayout()->createBlock(
            ...
            [
                'params' => $this->getData(),
                'items'  => $this->getRepeatableField('repeatable_tab_items')
            ]
        )->toHtml();
    }
}
